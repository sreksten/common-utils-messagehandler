 ...
 * after every write to decide whether the current log file should be archived and a new one started.
 * <p>
 ...
 *       — rotates when the estimated bytes written since the last open exceeds a configurable
 *       threshold.</li>
...
public interface RotationPolicy {
     ...
     * written. Implementations should be cheap (no blocking I/O) and idempotent.
     *
     ...
     * rename. It must not already exist; if it does, the rotation will fail with an
