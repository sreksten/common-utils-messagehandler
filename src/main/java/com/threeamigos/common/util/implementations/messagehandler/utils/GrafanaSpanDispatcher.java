...
/**
 * OTLP span dispatcher for Grafana Tempo-compatible trace ingestion endpoints.
 */
public class GrafanaSpanDispatcher extends OtlpSpanDispatcher {

    public GrafanaSpanDispatcher(final @Nonnull String endpointUrl) {
        super(endpointUrl);
    }
